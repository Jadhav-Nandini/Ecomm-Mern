    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Sidebar */}
          <motion.aside
            className="fixed right-0 top-0 h-full w-80 bg-black text-white z-50 shadow-lg flex flex-col"
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            ...
            <nav className="flex-1 p-6 space-y-4">
              ...
              <a href="#" className="hover:text-yellow-400">Collections</a>
              <a href="#" className="hover:text-yellow-400">About</a>
              <a href="#" className="hover:text-yellow-400">Contact</a>
            </nav>
            <div className="p-6 border-t border-gray-800">
              <button className="w-full bg-gradient-to-r from-yellow-400 to-yellow-600 py-3 rounded-full font-medium">
                View Cart
              </button>
            </div>
          </motion.aside>
